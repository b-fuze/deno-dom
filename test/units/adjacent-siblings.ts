...
Deno.test("Adjacent siblings", () => {
  ...
  assertEquals(divMain?.previousSibling, null, "null is div.main's previousSibling");
  ...
  assertEquals(divB?.nextElementSibling, divC, "div.c is div.b's nextElementSibling");
  assertEquals(divC?.previousElementSibling, divB, "div.b is div.c's previousElementSibling");
});
